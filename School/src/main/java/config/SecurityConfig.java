    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers(HttpMethod.PUT, "/api/tests/**").authenticated()
                .requestMatchers(HttpMethod.DELETE, "/api/tests/**").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/course-lessons").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/course-lessons/**").authenticated()
